...
content.addEventListener("submit", async (event) => {
  ...
  const checks = ["paperless_verify_ssl", "automation_enabled", "allow_new_tags", "allow_new_correspondents", "allow_new_document_types", "allow_new_custom_fields", "notifications_enabled"];
